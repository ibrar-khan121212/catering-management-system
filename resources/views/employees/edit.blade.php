...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white py-10 px-4">
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 shadow rounded-lg p-8">
            ...
            <form method="POST" action="{{ route('employees.update', $item->Employee_ID) }}" class="space-y-5">
                @csrf
                @method('PUT')
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="Contact" id="Contact" value="{{ old('Contact', $item->Contact) }}" required class="w-full border rounded p-2">
                ...
                <div>
                    ...
                    <input type="number" name="Salary" id="Salary" step="0.01" value="{{ old('Salary', $item->Salary) }}" required class="w-full border rounded p-2">
