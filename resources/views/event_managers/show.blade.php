...
<div class="max-w-xl mx-auto p-8 bg-white dark:bg-gray-900 rounded-xl shadow-lg mt-10">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100">Event Manager Details</h1>
    ...
    <div class="mb-6 space-y-4">
        <div class="flex items-center">
            ...
            <span class="text-gray-900 dark:text-gray-100">{{ $item->Employee_ID }}</span>
        </div>
        <div class="flex items-center">
            <span class="w-48 font-semibold text-gray-700 dark:text-gray-200">Name:</span>
            <span class="text-gray-900 dark:text-gray-100">{{ $item->employee->Name ?? 'N/A' }}</span>
        </div>
        <div class="flex items-center">
            <span class="w-48 font-semibold text-gray-700 dark:text-gray-200">Managed Events Count:</span>
            <span class="text-gray-900 dark:text-gray-100">{{ $item->Managed_Events_Count }}</span>
        </div>
    </div>
    <div class="flex items-center gap-4 mt-8">
        <a href="{{ route('event_managers.index') }}" class="px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Back to List</a>
