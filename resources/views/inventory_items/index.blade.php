...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white py-10 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <a href="{{ route('inventory_items.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow mb-4 inline-block">+ Create New Item</a>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                <a href="{{ route('inventory_items.show', $item->Inventory_ID) }}" class="text-blue-600 hover:underline">View</a>
                                <a href="{{ route('inventory_items.edit', $item->Inventory_ID) }}" class="text-yellow-600 hover:underline">Edit</a>
