        ...
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 shadow rounded-lg p-8">
            ...
            <form method="POST" action="{{ route('inventory_items.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="Unit" id="Unit" value="{{ old('Unit') }}" required class="w-full border rounded p-2">
                ...
                <div>
                    ...
                    <input type="number" name="Quantity_Available" id="Quantity_Available" value="{{ old('Quantity_Available') }}" required class="w-full border rounded p-2">
