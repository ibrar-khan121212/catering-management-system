...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white py-10 px-4">
        <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 shadow rounded-lg p-8">
            ...
            <h1 class="text-2xl font-bold mb-6">Add New Chef</h1>
            <form method="POST" action="{{ route('chefs.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="Specialty" id="Specialty" value="{{ old('Specialty') }}" required class="w-full border rounded p-2">
